...
import { User, Activity, Shield, Calendar, ArrowRight, TrendingUp, Clock, Bell } from 'lucide-react'
    ...
    return (
      <Card>
        <CardContent className='pt-6'>
          <p className='text-center text-muted-foreground'>Faça login para ver seu dashboard</p>
        </CardContent>
      </Card>
    )
  }
