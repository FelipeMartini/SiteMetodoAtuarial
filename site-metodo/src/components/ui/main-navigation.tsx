  ...
  return (
    <NavigationMenu>
      <NavigationMenuList className='flex-wrap'>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={cn(pathname?.startsWith('/servicos') && 'bg-accent text-accent-foreground')}
          >
            Serviços
          </NavigationMenuTrigger>
          <NavigationMenuContent>
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div className='flex-1'>
                        <div className='flex items-center gap-2'>
                          <span className='text-sm font-medium leading-none'>{service.title}</span>
                          {service.badge && (
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={cn(pathname?.startsWith('/solucoes') && 'bg-accent text-accent-foreground')}
          >
            Soluções
          </NavigationMenuTrigger>
          <NavigationMenuContent>
                ...
                <NavigationMenuLink key={solution.href} asChild>
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      ...
                      <div className='flex-1'>
                        <span className='text-sm font-medium leading-none'>{solution.title}</span>
                        <p className='line-clamp-2 text-xs leading-snug text-muted-foreground'>
              ...
              <div className='row-span-3'>
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <div className='mb-2 mt-4 text-lg font-medium'>Método Atuarial</div>
                    <p className='text-sm leading-tight text-muted-foreground'>
                      Conheça nossa história, missão e valores. Mais de 15 anos transformando o
                      mercado atuarial.
                    </p>
                  </Link>
                </NavigationMenuLink>
