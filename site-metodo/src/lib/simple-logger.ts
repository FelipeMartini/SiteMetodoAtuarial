...
export const authLogger = {
  login: (userId: string, meta?: LogMeta) => simpleLogger.auth('login', { ...meta, userId }),
  logout: (userId: string, meta?: LogMeta) => simpleLogger.auth('logout', { ...meta, userId }),
  register: (email: string, meta?: LogMeta) => simpleLogger.auth('register', { ...meta, email }),
...
export const securityLogger = {
  suspiciousActivity: (event: string, meta?: LogMeta) => simpleLogger.security(event, 'high', meta),
