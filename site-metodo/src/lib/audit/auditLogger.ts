...
export class AuditLogger {
  ...
  async log(data: AuditLogData): Promise<void> {
    try {
      ...
      console.error('[AUDIT] ❌ Failed to log audit event:', String(_error))
  ...
  async logUserCreation(
    adminUserId: string,
    adminEmail: string,
    adminRole: string[] | string | null,
    newUserId: string,
    newUserEmail: string,
    newUserRole: string[] | string | null
  ): Promise<void> {
    await this.log({
  ...
  async logRoleChange(
    ...
    oldRole: string[] | string | null,
    newRole: string[] | string | null
  ): Promise<void> {
    await this.log({
  ...
  async getStats(startDate?: Date, endDate?: Date) {
    ...
    const [totalEvents, failedEvents, eventsByAction] = await Promise.all([
