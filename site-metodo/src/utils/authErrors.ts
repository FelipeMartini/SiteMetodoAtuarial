...
export function mensagemAmigavel(code?: AuthErrorCode, fallback?: string): string {
  switch(code){
    case AuthErrorCode.EMAIL_JA_EXISTE: return 'Já existe um usuário cadastrado com este email.'
    case AuthErrorCode.DADOS_INVALIDOS: return 'Verifique os dados informados.'
    case AuthErrorCode.ERRO_INTERNO: return 'Ocorreu um erro interno. Tente novamente.'
    default: return fallback || 'Falha ao processar sua requisição.'
  }
}
