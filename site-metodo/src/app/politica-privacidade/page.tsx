      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='max-w-4xl mx-auto mb-8'>
          <Alert>
            ...
            <AlertDescription>
              Esta política está em conformidade com a Lei Geral de Proteção de Dados Pessoais (Lei
              nº 13.709/2018 - LGPD) e estabelece as diretrizes sobre tratamento de dados pessoais.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className='max-w-4xl mx-auto space-y-8'>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                <strong>Controlador de Dados:</strong> Método Atuarial Ltda.
                <br />
                <strong>CNPJ:</strong> [Número do CNPJ]
                <br />
                <strong>Endereço:</strong> [Endereço completo]
                <br />
                <strong>Email:</strong> privacidade@metodoatuarial.com.br
                <br />
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                <li>
                  <strong>Prestação de serviços:</strong> Fornecer consultoria atuarial e acesso à
                  plataforma
                </li>
                <li>
                  <strong>Comunicação:</strong> Responder dúvidas, enviar atualizações e informações
                  relevantes
                </li>
                <li>
                  <strong>Melhorias:</strong> Aprimorar nossos serviços e experiência do usuário
                </li>
                <li>
                  <strong>Segurança:</strong> Proteger contra fraudes e acessos não autorizados
                </li>
                <li>
                  <strong>Cumprimento legal:</strong> Atender obrigações regulamentares e fiscais
                </li>
                <li>
                  <strong>Marketing:</strong> Enviar informações sobre novos serviços (mediante
                  consentimento)
                </li>
              </ul>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                O tratamento de seus dados pessoais está fundamentado nas seguintes bases legais da
                LGPD:
              </p>
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                <li>
                ...
                <li>
                  <strong>Legítimo interesse (Art. 7º, IX):</strong> Para melhorias e segurança do
                  serviço
                </li>
                <li>
                  <strong>Consentimento (Art. 7º, I):</strong> Para comunicações de marketing
                </li>
                <li>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                <li>
                  <strong>Prestadores de serviços:</strong> Empresas que nos auxiliam na prestação
                  dos serviços
                </li>
                <li>
                  <strong>Autoridades:</strong> Quando exigido por lei ou autoridades competentes
                </li>
                <li>
                  <strong>Parceiros de negócio:</strong> Mediante seu consentimento explícito
                </li>
                <li>
                  <strong>Sucessão empresarial:</strong> Em caso de fusão, aquisição ou
                  reorganização
                </li>
              </ul>
              <p className='text-muted-foreground leading-relaxed mt-4'>
                <strong>Importante:</strong> Não vendemos, alugamos ou comercializamos seus dados
                pessoais para terceiros para fins de marketing sem seu consentimento explícito.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                <li>
                  <strong>Dados contratuais:</strong> Durante a vigência do contrato + 5 anos
                </li>
                <li>
                  <strong>Dados fiscais:</strong> Conforme exigências legais (tipicamente 5 anos)
                </li>
                <li>
                  <strong>Dados de marketing:</strong> Até a retirada do consentimento
                </li>
                <li>
                  <strong>Dados de navegação:</strong> Até 12 meses
                </li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                ...
                <li>
                  <strong>Anonimização ou eliminação:</strong> Eliminar dados desnecessários ou
                  excessivos
                </li>
                <li>
                ...
                <li>
                  <strong>Eliminação:</strong> Eliminar dados tratados com base no consentimento
                </li>
                <li>
                ...
                <li>
                  <strong>Oposição:</strong> Opor-se ao tratamento em certas circunstâncias
                </li>
              </ul>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              ...
              <ul className='list-disc list-inside space-y-2 text-muted-foreground ml-4'>
                <li>
                  <strong>Essenciais:</strong> Garantir o funcionamento básico do site
                </li>
                <li>
                  <strong>Funcionais:</strong> Lembrar suas preferências e configurações
                </li>
                <li>
                  <strong>Analíticos:</strong> Entender como você usa nosso site
                </li>
                <li>
                  <strong>Marketing:</strong> Personalizar anúncios (mediante consentimento)
                </li>
              </ul>
              <p className='text-muted-foreground leading-relaxed mt-4'>
