  ...
  <div className='space-y-6'>
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Realize cálculos de seguro de vida, anuidades e análises de mortalidade
        </CardDescription>
      </CardHeader>
      <CardContent>
  ...
  <div className='space-y-6'>
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Importe ou gerencie tabelas de mortalidade para cálculos atuariais
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className='text-center py-12 text-muted-foreground'>
  ...
  return (
    <div className='container mx-auto p-6 space-y-6'>
      ...
      <div className='flex justify-between items-start'>
        <div>
          <h1 className='text-4xl font-bold tracking-tight gradient-text'>Cálculos Atuariais</h1>
      ...
      <div className='grid gap-4 md:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Cálculos nas últimas 24h</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Todos os módulos funcionais</p>
          </CardContent>
        </Card>
      </div>
      ...
      {mortalityTables.length === 0 && (
        <Alert>
          ...
          <AlertDescription>
            Nenhuma tabela de mortalidade encontrada. As tabelas padrão brasileiras estão sendo
            carregadas automaticamente. Você pode importar suas próprias tabelas na aba
            &ldquo;Tabelas de Mortalidade&rdquo;.
          </AlertDescription>
        </Alert>
      )}
          ...
          <div className='grid gap-6 md:grid-cols-2'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Como utilizar o sistema de cálculos atuariais</CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div>
                  <h3 className='font-semibold mb-2'>1. Importar Tabelas de Mortalidade</h3>
                  <p className='text-sm text-muted-foreground'>
                    Comece importando ou criando tabelas de mortalidade. O sistema já inclui tabelas
                    brasileiras padrão (BR-EMS 2020).
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Use a calculadora para realizar cálculos de seguro de vida, anuidades e análises
                    de mortalidade baseados nas tabelas disponíveis.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Visualize relatórios detalhados, gráficos e análises comparativas dos cálculos
                    realizados.
                  </p>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Referência matemática dos cálculos implementados</CardDescription>
              </CardHeader>
              <CardContent className='space-y-4'>
                <div>
                  ...
                  <div className='text-sm space-y-1'>
                    <div>
                      <code>qx</code> - Taxa de mortalidade na idade x
                    </div>
                    <div>
                      <code>px</code> - Taxa de sobrevivência (px = 1 - qx)
                    </div>
                    <div>
                      <code>lx</code> - Número de sobreviventes na idade x
                    </div>
                    <div>
                      <code>ex</code> - Expectativa de vida na idade x
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='text-sm space-y-1'>
                    <div>
                      <code>Ax</code> - Valor presente do seguro vitalício
                    </div>
                    <div>
                      <code>Px</code> - Prêmio anual nivelado
                    </div>
                    <div>
                      <code>äx</code> - Anuidade vitalícia antecipada
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className='text-sm space-y-1'>
                    <div>
                      <code>ax</code> - Anuidade vitalícia postecipada
                    </div>
                    <div>
                      <code>äx</code> - Anuidade vitalícia antecipada
                    </div>
                    <div>
                      <code>ax:n</code> - Anuidade temporária n anos
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Funcionalidades implementadas no sistema</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Recursos adicionais e canais de suporte</CardDescription>
              </CardHeader>
