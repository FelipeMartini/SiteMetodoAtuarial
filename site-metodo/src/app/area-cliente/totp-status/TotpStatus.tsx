...
export default function TotpStatus() {
  ...
  return (
    <div className="my-4">
      {enabled ? (
        <>
          <Alert variant="default">MFA TOTP está <b>ATIVO</b> para sua conta.</Alert>
          <Button onClick={handleDisable} variant="destructive" className="mt-2">Desativar MFA</Button>
        </>
      ) : (
  <Alert variant="default">MFA TOTP está <b>INATIVO</b> para sua conta.</Alert>
      )}
