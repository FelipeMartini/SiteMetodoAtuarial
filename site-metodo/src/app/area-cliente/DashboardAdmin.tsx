...
const DashboardAdmin: React.FC = () => {
  ...
  const handleChangeNivel = async (id: string, nivel: number) => {
    ...
    const data = await res.json()
    setUsuarios(
      data.usuarios || usuarios.map(u => (u.id === id ? { ...u, accessLevel: nivel } : u))
    )
  }
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>+{stats.novosMes} este mês</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Nível de acesso 100+</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>Uptime último mês</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
            {Object.entries(flags).map(([flag, value]) => (
              <div
                key={flag}
                className='flex items-center justify-between space-x-2 p-3 rounded-lg border bg-muted/50'
              >
        ...
        <TabsContent value='usuarios' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Gerencie usuários, permissões e níveis de acesso</CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              ...
              {selecionados.length > 0 && (
                <div className='flex flex-wrap items-center gap-2 p-3 bg-muted rounded-lg border animate-in fade-in'>
                  ...
                  <Button size='sm' variant='secondary' onClick={handleBatchChangeRole}>
                    Alterar Papel
                  </Button>
                  <Button size='sm' variant='outline' onClick={handleBatchResetMFA}>
                    Resetar MFA
                  </Button>
                </div>
              )}
              ...
              <UsuariosTable
                ...
                todosSelecionados={
                  ...
                  usuariosPagina.every(u => selecionados.includes(u.id))
                }
        ...
        <TabsContent value='analytics' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Visualize métricas de uso e performance do sistema</CardDescription>
            </CardHeader>
            <CardContent>
              <div className='text-center py-8 text-muted-foreground'>
