    ...
    switch (errorType) {
      case 'OAuthAccountNotLinked':
        return {
          ...
          description: 'Já existe uma conta com este email. Para maior segurança, por favor faça login com sua senha ou solicite a recuperação de senha.',
      ...
      case 'AccessDenied':
        return {
          ...
          suggestion: 'Para fazer login, é necessário permitir o acesso às informações básicas do seu perfil.'
        };
      case 'Verification':
        return {
      ...
      <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <Button asChild className="w-full" variant={error === 'OAuthAccountNotLinked' ? 'outline' : 'default'}>
              <Link href="/login" className="flex items-center gap-2">
