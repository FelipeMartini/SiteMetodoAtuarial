...
const services = [
  {
    ...
    descricao:
      'Análise de riscos e avaliação de passivos previdenciários com metodologias avançadas',
    icon: Calculator,
    badge: 'Especialidade',
...
const testimonials = [
  {
    ...
    feedback:
      'Excelência técnica e agilidade na entrega dos relatórios. Superaram nossas expectativas.',
    rating: 5,
    author: 'João Silva',
              ...
              <div className='flex flex-col sm:flex-row gap-4 pt-6 animate-slide-up'>
                <Link href='/contato'>
                  <Button
                    size='lg'
                    variant='default'
                    className='px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl'
                  >
                    Solicitar Orçamento
                ...
                <TabsContent key={service.id} value={service.id}>
                  <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                    <Card variant='elevated' hover='lift' className='h-full'>
                      <CardHeader className='space-y-4'>
                        <div className='flex items-center gap-4'>
                          <div
                            className={`h-16 w-16 rounded-xl bg-gradient-to-br ${service.color} flex items-center justify-center shadow-lg`}
                          >
                    ...
                    <div className='relative'>
                      <div
                        className={`aspect-square bg-gradient-to-br ${service.color} rounded-3xl shadow-2xl flex items-center justify-center relative overflow-hidden`}
                      >
