      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
            Há mais de uma década construindo soluções inovadoras para o mercado de previdência e
            seguros, combinando expertise técnica com tecnologia de ponta.
          </p>
        </div>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                <div>
                  ...
                  <p className='text-muted-foreground leading-relaxed mb-6'>
                    Fundada em 2010, o Método Atuarial nasceu da visão de democratizar o acesso a
                    soluções atuariais de alta qualidade. Começamos como uma pequena consultoria
                    especializada e evoluímos para uma empresa de referência no mercado brasileiro.
                  </p>
                  <p className='text-muted-foreground leading-relaxed mb-6'>
                    Ao longo dos anos, desenvolvemos metodologias próprias e ferramentas
                    tecnológicas que revolucionaram a forma como nossos clientes gerenciam seus
                    riscos atuariais.
                  </p>
          ...
          <Card className='text-center group hover:shadow-lg transition-all duration-300'>
            ...
            <CardContent>
              <p className='text-muted-foreground leading-relaxed'>
                Fornecer soluções atuariais inovadoras e acessíveis, promovendo a sustentabilidade e
                transparência dos sistemas previdenciários e de seguros no Brasil.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='text-center group hover:shadow-lg transition-all duration-300'>
            ...
            <CardContent>
              <ul className='text-muted-foreground space-y-2 text-left'>
                <li>
                  • <strong>Excelência:</strong> Qualidade em cada entrega
                </li>
                <li>
                  • <strong>Inovação:</strong> Tecnologia a serviço do cliente
                </li>
                <li>
                  • <strong>Transparência:</strong> Comunicação clara e honesta
                </li>
                <li>
                  • <strong>Ética:</strong> Integridade em todas as relações
                </li>
              </ul>
            </CardContent>
          </Card>
        ...
        <div className='mb-20'>
          <div className='text-center mb-12'>
            <h2 className='text-3xl md:text-4xl font-bold text-foreground mb-4'>Nossos Números</h2>
        ...
        <div className='mb-20'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
              Profissionais altamente qualificados e certificados nas principais instituições do
              país
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <Card className='text-center group hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-8'>
                ...
                <p className='text-sm text-muted-foreground mb-4'>
                  PhD em Ciências Atuariais, MIBA, com mais de 20 anos de experiência em previdência
                  complementar.
                </p>
            ...
            <Card className='text-center group hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-8'>
                ...
                <p className='text-sm text-muted-foreground mb-4'>
                  Mestrado em Estatística, especialista em modelagem de riscos e desenvolvimento de
                  sistemas.
                </p>
                <div className='flex flex-wrap gap-2 justify-center'>
                  <Badge variant='outline' className='text-xs'>
            ...
            <Card className='text-center group hover:shadow-lg transition-all duration-300'>
              <CardContent className='p-8'>
                ...
                <p className='text-sm text-muted-foreground mb-4'>
                  Atuário formado pela UFRJ, especialista em avaliações atuariais e gestão de fundos
                  de pensão.
                </p>
                <div className='flex flex-wrap gap-2 justify-center'>
                  <Badge variant='outline' className='text-xs'>
        ...
        <div className='mb-20'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-muted-foreground'>
              Nosso compromisso com a excelência é reconhecido pelas principais instituições do
              mercado
            </p>
          </div>
          ...
          <Card className='border-0 shadow-lg bg-gradient-to-r from-primary/10 to-secondary/10'>
            <CardContent className='p-12'>
              ...
              <p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto'>
                Entre em contato conosco e descubra como podemos ajudar sua organização a alcançar
                novos patamares de excelência atuarial.
              </p>
