    ...
    <div className='container mx-auto p-6 space-y-6'>
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-muted-foreground'>Status e métricas das integrações externas</p>
        </div>
        ...
        <div className='flex gap-2'>
          ...
          <Button onClick={() => runTests('all')} disabled={testLoading}>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-2xl font-bold'>
                    {(
                      (metrics.systemMetrics.totalErrors / metrics.systemMetrics.totalRequests) *
                      100
                    ).toFixed(2)}
                    %
                  </div>
                ...
                <Card key={type}>
                  ...
                  <CardContent className='space-y-3'>
                    <div className='flex justify-between'>
                      ...
                      <span className='text-sm font-medium'>{calculateCacheHitRate(stats)}%</span>
                    </div>

                    <Progress value={Number(calculateCacheHitRate(stats))} className='h-2' />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Execute testes completos da infraestrutura</CardDescription>
              </CardHeader>
              <CardContent className='space-y-2'>
                <Button onClick={() => runTests('all')} disabled={testLoading} className='w-full'>
                  Teste Completo
                </Button>
                <Button
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Teste um CEP específico</CardDescription>
              </CardHeader>
              <CardContent className='space-y-2'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Teste uma conversão específica</CardDescription>
              </CardHeader>
              <CardContent className='space-y-2'>
