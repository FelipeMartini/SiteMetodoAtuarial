...
export default function DocumentacaoPage() {
  ...
  const filteredDocumentacoes = documentacoes
    .map(categoria => ({
      ...categoria,
      itens: categoria.itens.filter(
        item =>
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto mb-8'>
            Guias completos, APIs, metodologias e recursos para desenvolvedores e profissionais que
            utilizam nossas soluções atuariais.
          </p>
                      ...
                      >
                        ...
                        <CardContent className='space-y-4'>
                          ...
                          <div className='flex items-center justify-between'>
                            <Badge
                              variant='outline'
                              className={`text-xs ${getNivelColor(item.nivel)}`}
                            >
                              {item.nivel}
                            </Badge>
                          ...
                          <Button variant='ghost' size='sm' className='w-full' asChild>
                            <Link href={item.link}>Ver Documentação</Link>
                          </Button>
                        </CardContent>
                      </Card>
                    ))}
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <p className='text-sm text-muted-foreground'>
                  Todos os recursos disponibilizados nesta seção estão sujeitos aos nossos termos de
                  uso e políticas de licenciamento. Antes de fazer o download, certifique-se de ler
                  e aceitar as condições.
                </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                ...
                <CardContent className='space-y-4'>
                  <div className='space-y-4'>
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        Acesse sua área cliente e navegue até &quot;Configurações &gt; API
                        Keys&quot; para gerar uma nova chave de autenticação.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'>
                        O limite padrão é de 1000 requisições por hora. Limites maiores estão
                        disponíveis nos planos premium.
                      </p>
                    </div>

                    <div>
                      <h4 className='font-semibold text-foreground mb-2'>Como relatar um bug?</h4>
                      <p className='text-sm text-muted-foreground'>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Entre em contato com nossa equipe especializada</CardDescription>
                </CardHeader>
                <CardContent className='space-y-4'>
                  <div className='space-y-4'>
                    <div>
                      <h4 className='font-semibold text-foreground mb-1'>Email</h4>
                      <p className='text-sm text-muted-foreground'>suporte@metodoatuarial.com.br</p>
                    </div>
                  ...
                  <Button className='w-full' asChild>
                    <Link href='/contato'>Abrir Ticket de Suporte</Link>
                  </Button>
                </CardContent>
              </Card>
            </div>
