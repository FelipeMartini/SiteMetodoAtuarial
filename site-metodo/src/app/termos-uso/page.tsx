      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
            Estes termos de uso regem o uso do site e serviços do Método Atuarial. Ao utilizar
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                Ao acessar e usar o site do Método Atuarial (&quot;Site&quot;), você aceita e
                concorda em ficar vinculado aos termos e condições deste Acordo. Se você não
                concordar com todos os termos e condições deste acordo, então você não pode acessar
                o Site ou usar qualquer serviço.
              </p>
              <p className='text-muted-foreground leading-relaxed'>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                ...
                propriedade exclusiva do Método Atuarial e seus licenciadores. O serviço é protegido
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                ...
                incidentais, especiais, consequentes ou punitivos, incluindo sem limitação, perda de
                lucros, dados, uso, goodwill ou outras perdas intangíveis.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <p className='text-muted-foreground leading-relaxed'>
                ...
                Termos a qualquer momento. Se uma revisão for material, tentaremos fornecer pelo
                menos 30 dias de aviso antes de quaisquer novos termos entrarem em vigor.
              </p>
            </CardContent>
          </Card>
